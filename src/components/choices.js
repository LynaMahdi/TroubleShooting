...
const Choices=({os,setProblemH, setProblemS,setProblemB,problemH,problemS , problemB})=>{
     ...
     <div className="container">
           ...
           <select className="se"    style={{top:`420px`}} onChange={(e)=>{setProblemB(e.target.value)}}>
            {boot.map(o=>(
             ...
             <Link className="btn" to="/Result" style={{left:`260px` , top:`530px`,color:`transparent`}}><h3  style={{left:`65px` , color:`#e07a5f`}}>Show The Problem</h3></Link> 
